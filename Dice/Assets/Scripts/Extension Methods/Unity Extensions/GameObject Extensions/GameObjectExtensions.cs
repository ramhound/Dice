...
public static partial class GameObjectExtensions {
    ...
    /// <returns></returns>
    public static T FindByType<T>(this GameObject gameObject) where T : Component {
    ...
    public static T FindChildByType<T>(this GameObject gameObject) where T : Component {
        return gameObject.transform.FindByType<T>();
    }
    ...
    /// <param name="tag"></param>
    /// <returns></returns>
    public static T FindByTypeRecursively<T>(this GameObject gameObject) where T : Component {
        for(int i = 0; i < gameObject.transform.childCount; i++) {
            T type = gameObject.transform.GetChild(i).gameObject.GetComponent<T>();
            if(type != null)
                return type;
        ...
        for(int i = 0; i < gameObject.transform.childCount; i++) {
            T returnedType = gameObject.transform.GetChild(i).FindByTypeRecursively<T>();
    ...
    public static T FindChildByTypeRecursively<T>(this GameObject gameObject) where T : Component {
        return gameObject.transform.FindByTypeRecursively<T>();
    }
